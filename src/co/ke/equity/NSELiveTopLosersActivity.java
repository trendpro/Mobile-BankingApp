...
public class NSELiveTopLosersActivity extends ParentListActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView (R.layout.activity_nse_live_top_losers);
    ...
    Thread thread =  new Thread(null, viewOrders, "MagentoBackground");
        thread.start();
        m_ProgressDialog = ProgressDialog.show(NSELiveTopLosersActivity.this,    
	...
	private void getOrders(){
        try{
            ...
            m_orders = (ArrayList<ShareListingDataType>)qAccessClient.getTopLosers();
